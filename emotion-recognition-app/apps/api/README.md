...
- Call the FastAPI model service through `MODEL_API_URL`.
...
The API does not return model mocks. If the model service is unavailable, it returns a safe user-facing error and logs technical detail internally.
